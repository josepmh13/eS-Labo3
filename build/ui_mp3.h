...
public:
    ...
    {
        MP3->setWindowTitle(QApplication::translate("MP3", "Form", Q_NULLPTR));
        pushButton->setText(QString());
        playerStatus->setText(QString());
        btn_play->setText(QString());
        btn_stop->setText(QString());
        btn_previous->setText(QString());
        label->setText(QApplication::translate("MP3", "Progress", Q_NULLPTR));
        label_2->setText(QApplication::translate("MP3", "Volume", Q_NULLPTR));
        label_3->setText(QApplication::translate("MP3", " Now:", Q_NULLPTR));
